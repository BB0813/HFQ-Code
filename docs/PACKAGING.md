...
|----------|---------|--------|
| NSIS installer + portable | `pnpm pack:win` | `apps/desktop/release/HFQ Code-1.0.6-x64.exe` + `…-portable.exe` |
...
Release handoff notes: [RELEASE-1.0.6.md](./RELEASE-1.0.6.md) · [RELEASE-1.0.5.md](./RELEASE-1.0.5.md) · [RELEASE-1.0.4.md](./RELEASE-1.0.4.md) · [RELEASE-1.0.3.md](./RELEASE-1.0.3.md).
...
Product version comes from `apps/desktop/package.json` (currently **1.0.6**). Keep root `package.json` version aligned.
