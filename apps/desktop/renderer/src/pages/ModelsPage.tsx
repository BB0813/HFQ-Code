...
const PLATFORM_PRESETS: PlatformPreset[] = [
  ...
  },
  {
    ...
    models: "auto, glm-5.3-flash, glm-5.3, kimi-k2.7-code, deepseek-v4-pro, deepseek-v4-flash",
    defaultModel: "glm-5.3-flash",
    hint: "腾讯云大模型服务平台 · OpenAI 协议 /plan/v3；Anthropic 协议另有 /plan/anthropic，可另建 anthropic 渠道",
  },
  {
    id: "tokenhub-anthropic",
    label: "TokenHub Anthropic",
    kind: "anthropic",
    name: "TokenHub Anthropic",
    baseURL: "https://tokenhub.tencentmaas.com/plan/anthropic",
    models: "glm-5.3, kimi-k3, deepseek-v4-pro",
    defaultModel: "glm-5.3",
    hint: "TokenHub 的 Anthropic 协议端点 /plan/anthropic（与 OpenAI 端点可共用同一密钥）",
  },
  {
    id: "anthropic",
    label: "Anthropic",
