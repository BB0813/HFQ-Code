...
**1.1.7** — Windows 编程智能体（Phase-1+2 + Phase-3 + 1.0.x + 1.1.x + F1 + 1.1.6 全功能 + 更新 L1+L2 引导式后台下载）：
...
- 更新检查：多源回退（ghproxy 镜像 → ungh → 直连 GitHub）；**L1 可选后台下载** + **L2 就绪一键确认安装**（仍确认 + NSIS 向导；L3 静默 → 1.1.8）
...
- **1.1.7:** 更新 L1+L2 — `updatePolicy` · 后台自动下载 · 就绪 UI · 一键确认安装（非静默；L3 在 1.1.8）
...
| 版本 | 日期 | 摘要 |
|------|------|------|
| **[1.1.7](./docs/RELEASE-1.1.7.md)** | 2026-07-20 | 更新 L1+L2：后台自动下载 · 就绪 UI · 一键确认安装 · `updatePolicy`（silentInstall 占位至 1.1.8） |
